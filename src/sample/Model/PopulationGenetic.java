...
public class PopulationGenetic  {
	...
	// Genetic Algorithm 
	public SolutionGenetic geneticAlgorithm(int [][] matClauses,int populationNumber, int crossoverRate,int mutationRate,int maxIter, long execTime, int nbrLitteraux) {
		
		this.popsize=populationNumber;
		this.mutationRate=mutationRate;
		...
		while(!found) {
			...
			if((System.currentTimeMillis() - startTime) >= execTimeMillis || generation>maxIter )
				break;
